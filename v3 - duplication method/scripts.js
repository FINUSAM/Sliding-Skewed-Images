window.onload = function() {
    let card_data = ['football', 'cricket', 'badminton', 'esports', 'tt', 'football', 'cricket', 'badminton', 'esports', 'tt'];
    let card_colors = ['#FF5733', '#33FF57', '#3357FF', '#F1C40F', '#3232a8', '#FF5733', '#33FF57', '#3357FF', '#F1C40F', '#3232a8'];
